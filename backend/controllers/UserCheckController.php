...
use Yii;
use backend\search\UserCheckSearch;
...
/**
 * UserCheckController implements the CRUD actions for UserCheck model.
 */
class UserCheckController extends MController
{
    public function actions()
    {
        return [
            'index' => [
                ...
                'modelClass' => UserCheck::className(),
                'data' => function(){
                    
                        $searchModel = new UserCheckSearch();
