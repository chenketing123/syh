...
/* @var $model backend\search\TeamBookSearch */
...
<div class="row">
    ...
    <?= $form->field($model, 'team_id',['options'=>['tag'=>false]]) ?>

    <?= $form->field($model, 'book_id',['options'=>['tag'=>false]]) ?>

    <?= $form->field($model, 'detail_id',['options'=>['tag'=>false]]) ?>
