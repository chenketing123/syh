...
$this->title = 'practice Categories';
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <table class="table table-hover">
                        <a class="btn btn-white btn-sm" href="javascript:void(0);" title="添加" data-pjax="0" onclick="viewLayer('/backend/index.php/practice-category/edit.html',$(this))"><i class="fa fa-plus"></i> 添加</a>
                        <thead>
                        <tr>
                            <th>标题</th>
                            <th></th>
...
<script>
    ...
    function get_children(id,self) {
        if(  $('.'+id+'').length>0){
            ...
            $.ajax({
                type: "get",
                url: "<?php echo Url::to(['practice-category/get-children'])?>",
                dataType: "json",
                data: {"id":id},
