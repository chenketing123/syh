...
/* @var $model backend\search\PracticeCategorySearch */
...
<div class="row">
    ...
    <?= $form->field($model, 'level',['options'=>['tag'=>false]]) ?>

    <?= $form->field($model, 'sort',['options'=>['tag'=>false]]) ?>

    <?= $form->field($model, 'image',['options'=>['tag'=>false]]) ?>
