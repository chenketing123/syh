...
/* @var $model backend\search\BookSearch */
...
<div class="row">
    ...
    <?= $form->field($model, 'category_id',['options'=>['tag'=>false]])->dropDownList(\backend\models\BookCategory::getList(),['prompt'=>'']) ?>

    <?php  echo  $form->field($model, 'author',['options'=>['tag'=>false]]) ?>
