...
/* @var $searchModel backend\search\BookSearch */
...
//                        ],
                        ...
                        'created_at:datetime',
                        ['class' => 'yii\grid\ActionColumn', 'template' => '{update} {detail} {delete}',
                            'buttons' => [
                                ...
                                'detail' => function ($url, $model, $key) {
                                    ...
                                    $url=Url::to(['book-detail/index','book_id'=>$model->id]);
                                    return "<a href='javascript:void(0);'  type=\"button\" class=\"btn btn-primary btn-sm\"  onclick=\"viewLayer('$url',$(this))\" data-pjax='0' >内容设置</a>";
