...
/* @var $model backend\search\PracticeUserSearch */
...
<div class="row">
    ...
    <?= $form->field($model, 'id',['options'=>['tag'=>false]]) ?>
                ...
                <?= $form->field($model, 'practice_id', ['options' => ['tag' => false]])->widget(\kartik\select2\Select2::classname(), [
                    'data' => \backend\models\Practice::getList(),
                    'options' => [
                        'placeholder' => '请选择 ...',
                        'multiple' => false,
                    ],
