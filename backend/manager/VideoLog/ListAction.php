...
namespace backend\manager\VideoLog;
...
use Yii;
use backend\search\VideoLogSearch;
use yii\data\Pagination;
use backend\models\VideoLog;
...
class ListAction extends ManagerApiAction
{
    ...
    protected function runAction()
    {
        ...
        foreach ($models as $k => $v) {
            $list[$k]['id'] = $v['id'];
            $list[$k]['room_title'] = $v['room_title'];
            $list[$k]['video_title'] = $v['video_title'];
